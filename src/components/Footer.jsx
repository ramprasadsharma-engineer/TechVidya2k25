        ...
        >
          ...
          <div className="footer-section">
            ...
            <div className="footer-social">
              <motion.a href="#" whileHover={{ scale: 1.2, y: -3 }}>Instagram</motion.a>
              <motion.a href="#" whileHover={{ scale: 1.2, y: -3 }}>LinkedIn</motion.a>
              <motion.a href="#" whileHover={{ scale: 1.2, y: -3 }}>Twitter</motion.a>
              <motion.a href="#" whileHover={{ scale: 1.2, y: -3 }}>Facebook</motion.a>
            </div>
          </div>

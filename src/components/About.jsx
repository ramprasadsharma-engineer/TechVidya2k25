  ...
  return (
    <section className="section about-section" id="about" ref={ref}>
      ...
      >
        ...
        >
          Step into a world of innovation with:
        </motion.p>
        ...
        >
          💡 Hackathon, Paper Presentation, Code Decathlon, WebCraft, Optithon<br/>
          🎮 Valorant, BGMI, Free Fire, Clash Royale<br/>
          🎨 Artify, Imagify, Mindify, Ludify<br/>
          🧠 Quiz, CryptoHunt, Escape Room, Bridge The Gap, Dalal, Mark-King
        </motion.p>
